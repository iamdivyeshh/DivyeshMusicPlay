...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             ...
                             caption=f"▶️ **Paused** here the song \nPaused by {message.from_user.mention} \nvia @ZaYNxOP🎶🎸 😜"
    )
...
async def resume(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/6017c19c57946e03e650f.jpg", 
                             caption=f"▶️ **Resumed**\n Resumed By {message.from_user.mention}\nvia @ZaYNxOP🎶🎸 😜"
...
async def skip(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/6017c19c57946e03e650f.jpg", 
                             caption=f'**⏩Skipped**\nSkipeed by {message.from_user.mention} \nvia @ZaYNxOP🎶🎸 😜'
...
async def stop(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/6017c19c57946e03e650f.jpg", 
                             caption=f"**🔚Ended** \nEnded by {message.from_user.mention} \nvia @ZaYNxOP"
...
async def admincache(client, message: Message):
    ...
    await message.reply_photo(
                              photo="https://telegra.ph/file/6017c19c57946e03e650f.jpg",
                              caption=f'**🔃ReLoaded**\nReloaded by {message.from_user.mention} \nvia @ZaYNxOP 🎶🎸 😜'
           )
